...
class LinSVClassifier:
    ...
    def set_params(self, count: int) -> None:
        ...
        :return: None
        """
        self.__default = {'penalty': Param(ptype=[str, type(None)],
                                           def_val="l2",
                                           def_vals=['l1', 'l2'],
                                           is_locked=True),
                          'loss': Param(ptype=[str, type(None)],
                                        def_val="squared_hinge",
                                        def_vals=['hinge', 'squared_hinge'],
                                        is_locked=True),
                          ...
                          'multi_class': Param(ptype=[str, type(None)],
                                               def_val="ovr",
                                               def_vals=['ovr', 'crammer_singer'],
                                               is_locked=True),
    ...
    def fit(self,
        ...
        if grid_params and param_dict is None:
            self.model = LinearSVC(**self.__grid_best_params,
                                   verbose=verbose,
                                   random_state=13)
            ...
            self.model = LinearSVC(verbose=verbose,
                                   random_state=13)
        else:
