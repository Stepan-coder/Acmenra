...
class RidgeCVClassifier:
    ...
    def fit(self,
        ...
        if grid_params and param_dict is None:
            self.model = RidgeClassifierCV(**self.__grid_best_params)
            ...
            self.model = RidgeClassifierCV(**model_params)
