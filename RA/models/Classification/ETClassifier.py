...
class ETRegressor:
    def __init__(self,
                 ...
                 show: bool = False):
        """
        This method is the initiator of the ExtraTreesRegressor class
    ...
    def fit(self,
        ...
        if grid_params and param_dict is None:
            self.model = ExtraTreesClassifier(**self.__grid_best_params,
                                              n_jobs=n_jobs,
                                              verbose=verbose,
                                              random_state=13)
            ...
            self.model = ExtraTreesClassifier(n_jobs=n_jobs,
                                              verbose=verbose,
                                              random_state=13)
        else:
