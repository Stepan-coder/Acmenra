...
class GaussPClassifier:
    ...
    def set_params(self, count: int) -> None:
        ...
        self.__default = {'kernel': Param(ptype=[type(None)],
                          ...
                          'n_restarts_optimizer': Param(ptype=[int],
                                                        def_val=0,
                                                        def_vals=[0]),
                          'max_iter_predict': Param(ptype=[int],
                                                    def_val=100,
                                                    def_vals=[100]),
                          ...
                          'multi_class': Param(ptype=[str],
                                               def_val='one_vs_rest',
                                               def_vals=['one_vs_rest', 'one_vs_rest'],
                                               is_locked=True)}
    ...
    def fit(self,
        ...
        if grid_params and param_dict is None:
            self.model = GaussianProcessClassifier(**self.__grid_best_params,
                                                   random_state=13)
            ...
            self.model = GaussianProcessClassifier(**model_params,
                                                   random_state=13)
        elif not grid_params and param_dict is None:
            self.model = GaussianProcessClassifier(random_state=13)
        else:
    ...
    def fit_grid(self,
        ...
        if self.__show:
            ...
            show_grid_params(params=model_params,
                             ...
                             n_jobs=grid_n_jobs)
        model = GaussianProcessClassifier(random_state=13)
