...
class SVClassifier:
    ...
    def set_params(self, count: int):
        self.__default = {'C': Param(ptype=[float],
                                     def_val=1.0,
                                     def_vals=[1.0]),
                          'kernel': Param(ptype=[str],
                                          def_val="rbf",
                                          def_vals=['linear', 'poly', 'rbf', 'sigmoid', 'precomputed'],
                                          is_locked=True),
                          'degree': Param(ptype=[int],
                                          def_val=3,
                                          def_vals=conf_params(min_val=1,
                                                               max_val=count,
                                                               count=count,
                                                               ltype=int)),
                          'gamma': Param(ptype=[str],
                                         def_val="scale",
                                         def_vals=['scale', 'auto'],
                                         is_locked=True),
                          'coef0': Param(ptype=[float],
                                         def_val=0.0,
                                         def_vals=[0.0]),
                          'shrinking': Param(ptype=[bool],
                                             def_val=True,
                                             def_vals=[True, False],
                                             is_locked=True),
                          'probability': Param(ptype=[bool],
                                               def_val=False,
                                               def_vals=[True, False],
                                               is_locked=True),
                          ...
                          'max_iter': Param(ptype=[int],
                                            ...
                                            def_vals=conf_params(min_val=250,
                                                                 ...
                                                                 count=count,
                                                                 ltype=int)),
                          'decision_function_shape': Param(ptype=[str],
                                                           def_val="ovr",
                                                           def_vals=['ovr', 'ovo'],
                                                           is_locked=True),
                          'break_ties': Param(ptype=[bool],
                                              def_val=False,
                                              def_vals=[True, False],
                                              is_locked=True)}
    ...
    def fit(self,
        ...
        if grid_params and param_dict is None:
            self.model = SVC(**self.__grid_best_params,
                             verbose=verbose)
            ...
            self.model = SVC(verbose=verbose)
        else:
