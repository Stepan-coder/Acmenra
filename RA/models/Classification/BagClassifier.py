...
class BagClassifier:
        ...
        self.__default = {'base_estimator': Param(ptype=[type(None)],
                          ...
                          'n_estimators': Param(ptype=[int],
                                                ...
                                                def_vals=conf_params(min_val=20,
                                                                     ...
                                                                     count=count,
                                                                     ltype=int)),
                          'max_samples': Param(ptype=[float],
                                               def_val=1.0,
                                               def_vals=[1.0]),
                          'max_features': Param(ptype=[float],
                                                def_val=1.0,
                                                def_vals=[1.0]),
                          ...
                          'bootstrap': Param(ptype=[bool],
                                             ...
                                             def_vals=[True, False],
                                             is_locked=True),
                          'bootstrap_features': Param(ptype=[bool],
                                                      def_val=False,
                                                      def_vals=[True, False],
                                                      is_locked=True),
    ...
    def fit(self,
        ...
        if grid_params and param_dict is None:
            self.model = BaggingClassifier(**self.__grid_best_params,
                                           n_jobs=n_jobs,
                                           verbose=verbose,
                                           random_state=13)
            ...
            self.model = BaggingClassifier(**model_params,
                                           n_jobs=n_jobs,
                                           verbose=verbose,
                                           random_state=13)
        elif not grid_params and param_dict is None:
            self.model = BaggingClassifier(n_jobs=n_jobs,
                                           verbose=verbose,
                                           random_state=13)
        else:
    ...
    def __get_default_model_fit_time(self) -> float:
        ...
        model = BaggingClassifier(random_state=13)
