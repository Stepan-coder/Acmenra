...
class HGBClassifier:
    def __init__(self,
                 ...
                 show: bool = False):
        """
        This method is the initiator of the HistGradientBoostingClassifier class
        :param task: The training part of the dataset
        :param target: The target part of the dataset
        :param train_split: The coefficient of splitting into training and training samples
        :param show: The parameter responsible for displaying the progress of work
        """
        self.__text_name = "HistGradientBoostingClassifier"
        self.__importance = {}
    ...
    def set_params(self, count: int):
        self.__default = {"loss": Param(ptype=[str],
                                        def_val='auto',
                                        def_vals=['auto', 'binary_crossentropy', 'categorical_crossentropy'],
                                        is_locked=True),
                          ...
                          'max_iter': Param(ptype=[int],
                                            ...
                                            def_vals=conf_params(min_val=100,
                                                                 ...
                                                                 count=count,
                                                                 ltype=int)),
                          'max_leaf_nodes': Param(ptype=[int],
                                                  def_val=31,
                          ...
                          'min_samples_leaf': Param(ptype=[int],
                                                    ...
                                                    def_vals=conf_params(min_val=1,
                                                                         ...
                                                                         count=count,
                                                                         ltype=int)),
                          'l2_regularization': Param(ptype=[float],
                                                     def_val=0,
                                                     def_vals=conf_params(min_val=0,
                                                                          max_val=count * 2,
                                                                          count=count,
                                                                          ltype=float)),
                          'max_bins': Param(ptype=[int],
                                            def_val=255,
                                            def_vals=conf_params(min_val=1,
                                                                 max_val=255,
                                                                 count=count,
                                                                 ltype=int)),
                          'categorical_features': Param(ptype=[type(None)],
                                                        def_val=None,
                                                        def_vals=[None]),
                          'monotonic_cst': Param(ptype=[type(None)],
                                                 def_val=None,
                                                 def_vals=[None]),
                          'warm_start': Param(ptype=[bool],
                                              ...
                                              def_vals=[True, False],
                                              is_locked=True),
                          'early_stopping': Param(ptype=[bool, str],
                                                  def_val='auto',
                                                  def_vals=['auto', True, False],
                                                  is_locked=True),
                          'scoring': Param(ptype=[str, type(None)],
                                           def_val='loss',
                                           def_vals=['loss', None],
                                           is_locked=True),
    ...
    def fit(self,
        ...
        if grid_params and param_dict is None:
            self.model = HistGradientBoostingClassifier(**self.__grid_best_params,
                                                        verbose=verbose,
                                                        random_state=13)
            ...
            self.model = HistGradientBoostingClassifier(verbose=verbose,
                                                        random_state=13)
        else:
    ...
    def fit_grid(self,
        ...
        if self.__show:
            ...
            show_grid_params(params=model_params,
                             ...
                             n_jobs=grid_n_jobs)
        model = HistGradientBoostingClassifier(verbose=0,
                                               random_state=13)
