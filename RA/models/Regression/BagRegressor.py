...
class BagRegressor:
    ...
    def fit(self,
        ...
        if grid_params and param_dict is None:
            ...
            self.model = BaggingRegressor(**model_params,
                                          n_jobs=n_jobs,
                                          verbose=verbose,
                                          random_state=13)
        elif not grid_params and param_dict is None:
            self.model = BaggingRegressor(n_jobs=n_jobs,
                                          verbose=verbose,
                                          random_state=13)
        else:
