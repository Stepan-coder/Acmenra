...
from sklearn.linear_model import ARDRegression as ARDRRegression
...
class ARDRegression:
    ...
    def set_params(self, count: int) -> None:
        ...
        :return: None
        """
        self.__default = {'n_iter': Param(ptype=[int],
                                          def_val=300,
                                          def_vals=conf_params(min_val=25,
                                                               max_val=count,
                                                               count=count,
                                                               ltype=int)),
                          ...
                          'alpha_1': Param(ptype=[float],
                                           def_val=1e-6,
                                           def_vals=[1e-6]),
                          'alpha_2': Param(ptype=[float],
                                           def_val=1e-6,
                                           def_vals=[1e-6]),
                          'lambda_1': Param(ptype=[float],
                                            def_val=1e-6,
                                            def_vals=[1e-6]),
                          'lambda_2': Param(ptype=[float],
                                            def_val=1e-6,
                                            def_vals=[1e-6]),

                          'compute_score': Param(ptype=[bool],
                                                 def_val=False,
                                                 def_vals=[True, False],
                                                 is_locked=True),
                          'threshold_lambda': Param(ptype=[int],
                                                    def_val=10000,
