...
class PasAggrRegressor:
    ...
    def fit(self,
        ...
        if grid_params and param_dict is None:
            self.model = PassiveAggressiveRegressor(**self.__grid_best_params,
                                                    random_state=13)
            ...
            self.model = PassiveAggressiveRegressor(**model_params,
                                                    random_state=13)
        elif not grid_params and param_dict is None:
            self.model = PassiveAggressiveRegressor(random_state=13)
        else:
    ...
    def fit_grid(self,
        ...
        if self.__show:
            ...
            show_grid_params(params=model_params,
                             ...
                             n_jobs=grid_n_jobs)
        model = PassiveAggressiveRegressor(random_state=13)
