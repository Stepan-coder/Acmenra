...
class IsoRegression:
    ...
    def fit(self,
        ...
        if grid_params and param_dict is None:
            self.model = IsotonicRegression(**self.__grid_best_params)
            ...
            self.model = IsotonicRegression(**model_params)
