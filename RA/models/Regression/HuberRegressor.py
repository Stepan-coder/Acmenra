...
class HuberRRegressor:
    ...
    def fit(self,
        ...
        if grid_params and param_dict is None:
            self.model = HuberRegressor(**self.__grid_best_params)
            ...
            self.model = HuberRegressor(**model_params)
