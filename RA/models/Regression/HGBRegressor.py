...
class HGBRegressor:
    def __init__(self,
                 ...
                 show: bool = False):
        """
        This method is the initiator of the HistGradientBoostingRegressor class
        :param task: The training part of the dataset
        :param target: The target part of the dataset
        :param train_split: The coefficient of splitting into training and training samples
        :param show: The parameter responsible for displaying the progress of work
        """
        self.__text_name = "HistGradientBoostingRegressor"
        self.__importance = {}
    ...
    def fit(self,
        ...
        if grid_params and param_dict is None:
            self.model = HistGradientBoostingRegressor(**self.__grid_best_params,
                                                       verbose=verbose,
                                                       random_state=13)
            ...
            self.model = HistGradientBoostingRegressor(verbose=verbose,
                                                       random_state=13)
        else:
