...
class TSenRegressor:
    ...
    def set_params(self, count: int) -> None:
        ...
        self.__default = {'fit_intercept': Param(ptype=[bool],
                          ...
                          'copy_X': Param(ptype=[bool],
                                          ...
                                          def_vals=[True, False],
                                          is_locked=True),
                          'max_subpopulation': Param(ptype=[int],
                                                     def_val=1e4,
                                                     def_vals=[1e4]),
                          'n_subsamples': Param(ptype=[int, type(None)],
                                                def_val=None,
                                                def_vals=[None]),
    ...
    def fit(self,
        ...
        if grid_params and param_dict is None:
            self.model = TheilSenRegressor(**self.__grid_best_params,
                                           n_jobs=n_jobs,
                                           verbose=verbose,
                                           random_state=13)
            ...
            self.model = TheilSenRegressor(**model_params,
                                           n_jobs=n_jobs,
                                           verbose=verbose,
                                           random_state=13)
        elif not grid_params and param_dict is None:
            self.model = TheilSenRegressor(n_jobs=n_jobs,
                                           verbose=verbose,
                                           random_state=13)
        else:
    ...
    def __get_default_model_fit_time(self) -> float:
        ...
        model = TheilSenRegressor(random_state=13)
