...
class BayesianRidgeRegressor:
    def __init__(self,
        ...
        self.__default = {'n_iter': Param(ptype=[int],
                          ...
                          'lambda_2': Param(ptype=[float],
                                            def_val=1e-6,
                                            def_vals=[1e-6]),
                          'alpha_init': Param(ptype=[float, type(None)],
                                              def_val=None,
                                              def_vals=[None]),

                          'lambda_init': Param(ptype=[float, type(None)],
                                               def_val=None,
                                               def_vals=[None]),
    ...
    def __repr__(self):
        return f"'<Ra.{BayesianRidgeRegressor.__name__} model>'"
    ...
    def fit(self,
        ...
        if grid_params and param_dict is None:
            self.model = BayesianRidge(**self.__grid_best_params)
            ...
            self.model = BayesianRidge(**model_params)
