...
class LarsRegressor:
    def __init__(self,
                 ...
                 show: bool = False):
        """
        This method is the initiator of the LarsRegressor class
        ...
        self.__default = {'fit_intercept': Param(ptype=[bool],
                          ...
                          'precompute': Param(ptype=[bool],
                                              ...
                                              def_vals=[True, False],
                                              is_locked=True),
                          'n_nonzero_coefs': Param(ptype=[int],
                                                   def_val=500,
    ...
    def __repr__(self):
        return f"'<Ra.{LarsRegressor.__name__} model>'"
    ...
    def fit(self,
        ...
        if grid_params and param_dict is None:
            self.model = Lars(**self.__grid_best_params,
                              random_state=13)
            ...
            self.model = Lars(**model_params,
                              random_state=13)
        elif not grid_params and param_dict is None:
            self.model = Lars(random_state=13)
        else:
