...
manager.DataSet("Original DataSet").add_row(new_row={"A": 1, "B": True})
manager.DataSet("Original DataSet").add_row(new_row={"A": 2, "B": True})
...
print(manager.DataSet("Original DataSet").get_column_statinfo(column_name="A", extended=True))
#
